...
MIDDLEWARE = [
    ...
    'courrier.middleware.ProtectedMediaMiddleware',
...
DATA_UPLOAD_MAX_NUMBER_FIELDS = int(os.getenv("DJANGO_DATA_UPLOAD_MAX_NUMBER_FIELDS", "100"))
...
# Email — console en développement, SMTP si configuré en production.
...
DEFAULT_FROM_EMAIL = os.getenv("DJANGO_DEFAULT_FROM_EMAIL", "gec@localhost")
